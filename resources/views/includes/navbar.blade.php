<nav class="bg-white border-gray-200  bg-white border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-800">
        ...
        <div class="flex md:order-2">
            ...
            <!-- Dark mode switcher -->
                <button
                    ...
                    class="text-gray-500 dark:text-gray-300 dark:bg-gray-900 bg-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"
                    >
                    <svg
